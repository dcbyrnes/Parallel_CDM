...
-- If z is a vector then we add elements
-- with z.i = ...   
fspace Vector {
    i : double
}
...
--[[
-- Function f(x,y) = (x + y - 1)^2
terra func(z : Vector2d)
    --return cmath.pow(z.x + z.y - 1, 2) 
    return cmath.pow(z.x - 1,2) + cmath.pow(z.y - 1, 2) 
end
--]]
